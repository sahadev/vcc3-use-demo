...
declare const DynamicSizeList: import("vue").DefineComponent<{
    ...
    readonly itemSize: import("../../../../utils/props").BuildPropReturn<import("../../../../utils/props").PropWrapper<number | ItemSize>, never, true, never, never>;
}, {
    ...
    itemSize: import("../../../../utils/props").BuildPropType<import("../../../../utils/props").PropWrapper<number | ItemSize>, never, never>;
} & {
