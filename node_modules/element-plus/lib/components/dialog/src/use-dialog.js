...
const useDialog = (props, { emit }, targetRef) => {
  ...
  const zIndex = vue.ref(props.zIndex || popupManager.PopupManager.nextZIndex());
  ...
  index$2.useRestoreActive(visible);
  vue.watch(() => props.modelValue, (val) => {
    if (val) {
      ...
      rendered.value = true;
      emit("open");
      zIndex.value = props.zIndex ? zIndex.value++ : popupManager.PopupManager.nextZIndex();
      vue.nextTick(() => {
        if (targetRef.value) {
