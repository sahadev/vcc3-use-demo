...
declare const _Popover: SFCWithInstall<import("vue").DefineComponent<{
    ...
    enterable: {
        default: boolean;
        type: import("vue").PropType<import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>>;
        required: false;
    ...
    popperRef: import("vue").ComputedRef<({
        ...
        $nextTick: typeof import("vue").nextTick;
        $watch(source: string | Function, cb: Function, options?: import("vue").WatchOptions<boolean> | undefined): import("vue").WatchStopHandle;
    } & Readonly<{} & {} & {}> & import("vue").ShallowUnwrapRef<import("..").ElPopperInjectionContext> & {} & {} & import("vue").ComponentCustomProperties) | null | undefined>;
    ...
    width: import("../../utils/props").BuildPropType<(StringConstructor | NumberConstructor)[], unknown, unknown>;
    content: string;
    effect: string;
    enterable: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    popperClass: string | {
