...
export declare const spaceProps: {
    ...
    readonly size: import("element-plus/es/utils/props").BuildPropReturn<readonly [StringConstructor, ArrayConstructor, NumberConstructor], unknown, unknown, "small" | "default" | "large", number | [number, number]>;
};
...
declare const _default: import("vue").DefineComponent<{
    ...
    size?: import("element-plus/es/utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "default" | "large", number | [number, number]> | undefined;
    prefixCls?: string | undefined;
}>, {
    size: import("element-plus/es/utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "default" | "large", number | [number, number]>;
    fill: import("element-plus/es/utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    style: StyleValue;
    class: import("element-plus/es/utils/props").BuildPropType<import("element-plus/es/utils/props").PropWrapper<string | string[] | Record<string, boolean>>, unknown, unknown>;
    wrap: import("element-plus/es/utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
