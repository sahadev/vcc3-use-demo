...
function useStyles(props) {
  ...
  const getCellStyle = (rowIndex, columnIndex, row, column) => {
    ...
    const fixedStyle = util.getFixedColumnOffset(columnIndex, props.fixed, props.store);
    util.ensurePosition(fixedStyle, "left");
    util.ensurePosition(fixedStyle, "right");
    return Object.assign({}, cellStyles, fixedStyle);
  };
  const getCellClass = (rowIndex, columnIndex, row, column) => {
    const fixedClasses = column.isSubColumn ? [] : util.getFixedColumnsClass(columnIndex, props.fixed, props.store);
